...
function bixxs_events_addingOrderDeliveryFunc(){
	...
	if($status){
		add_menu_page(__("Veranstaltungen" , BIXXS_EVENTS_TEXTDOMAIN) , __('Veranstaltungen', BIXXS_EVENTS_TEXTDOMAIN) , "administrator", 'bixxs-events' , 'bixxs_events_eventMenuPage', 'dashicons-calendar-alt');
	}	
}
...
<table border="0" width="100%">
	<tr>
		<td valign="top" width="50%"><ul style="padding-left:30px; list-style:circle">
			<li>Veranstaltung</li>
			<li>Events</li>
			<li>und weitere ...</li>
		</ul></td>
