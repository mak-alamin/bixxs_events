...
function addingtickesbixxs_events_einstellungenFunc(){
	...
	if($status){
		add_submenu_page("bixxs-events", __("Veranstaltungseinstellungen" , BIXXS_EVENTS_TEXTDOMAIN) , __('Veranstaltungseinstellungen', BIXXS_EVENTS_TEXTDOMAIN) , 'administrator' , 'bixxs-events-einstellungen' , 'tickesbixxs_events_einstellungenFunc');
	}	
}		
...
<input type="text" name="produktname_top" size="12" value="<?php echo $set_produktname_top; ?>"></div>
...
<input type="text" name="order_date_top" size="12" value="<?php echo $set_order_date_top; ?>"></div>
...
<input type="text" name="price_top" size="12" value="<?php echo $set_price_top; ?>"></div>
...
<input type="text" name="termien_top" size="12" value="<?php echo $set_termien_top; ?>"></div>
...
<input type="text" name="veranstallter_top" size="12" value="<?php echo $set_veranstallter_top; ?>"></div>
...
<input type="text" name="veranstallter_ort_top" size="12" value="<?php echo $set_veranstallter_ort_top; ?>"></div>

<div class="divTableCell">Veranstalter  Farbe:
<input type="text" name="veranstallter_ort_color" size="12" value="<?php echo $set_veranstallter_ort_color; ?>"></div>
</div>
...
<input type="text" name="menge_top" size="12" value="<?php echo $set_menge_top; ?>"></div>
