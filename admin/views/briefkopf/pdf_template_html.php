...
<div class="pdf-template">
    ...
    <div class="ticket-body">
        <b style="position:absolute; top:<?php echo $produktname_top; ?>px; left: <?php echo $produktname_left; ?>px; color: <?php echo $productname_color; ?>"><!--Name:--> <?php echo $ticket_name; ?></b>
        ...
        <?php if ( $ticket_template_id != 0 ) { ?>
            ...
            <span style="position: absolute;top: <?php echo $ticket_number_top;?>px;left: <?php echo $ticket_number_left;?>px;color:<?php echo $ticket_number_color;?>">Ticketnummer: 
        <?php
        } else{
    ...
    <div class="additional-info">
        ...
        <span><?php echo $this->ticketmaster_general_options['additional_info'];?></span></p>

        <p><b>Auswahl:</b><br>
        <span><?php echo  $bixxs_events_addons; ?></span></p>
