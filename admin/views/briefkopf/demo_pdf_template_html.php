...
<style>
    ...
    .ticket-body b, .ticket-body span{
...
<div class="pdf-template">
    <div class="header">
        <div class="logo">
            <img src="<?php echo $ticketmaster_general_options['logo']; ?>" alt="" width="120">
        </div>   
    ...
    <div class="header-address">
         <p><b><?php echo $ticketmaster_general_options['heading'] ;?></b><p>
        
        <span>Michael Lenuweit</span><br>
        <span>Marie-Curie-Strasse 6</span><br>
        <span>47475 Kamp-Lintfort</span><br><br>
        <span><?php echo $ticketmaster_general_options['info'];?> </span>
    </div>
    ...
    <div class="ticket-body">
           ...
           <span style="position:absolute;top: 170px;left: 50px;" class="veranstalter">Veranstalter: Veranstalter</span>
            ...
            <img src="<?php echo plugins_url('/wp-content/plugins/bixxs_events/img/demo_qrcode.png'); ?>" alt="" class="qr-code" style="display:inline-block;position:absolute; top:240px;left:580px;" width="100" height="100">
            
            <img src="<?php echo plugins_url('https://sbt.bixxs.de/wp-content/plugins/bixxs_events/img/demo_ticket_bg.jpg'); ?>" alt="" class="ticket_bg" width="700" height="352">
    </div>

    <div class="additional-info">
        <p><b>Zusammenfassung:</b>
            <span><?php echo $ticketmaster_general_options['additional_info'];?></span></p>
    ...
    <div class="footer">
        ...
        <div class="footer-box">
            <small><?php echo nl2br($ticketmaster_general_options['footer'][2]); ?></small>
        </div>
        <div class="footer-box">
