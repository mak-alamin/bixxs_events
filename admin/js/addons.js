document.addEventListener("DOMContentLoaded", function(event) {
    ...
    let addonSelections = document.querySelectorAll('.bixxs_events_addons_selection');
    ...
    for (const addonSelection of addonSelections){
        addonSelection.addEventListener('change', (event) => {
            ...
            let price_person = document.getElementById('bixxs_events_field[' + id + '][price_person]');
            let price_event = document.getElementById('bixxs_events_field[' + id + '][price_event]');
    ...
    document.getElementById('bixxs_events_add_addon').onclick = () => {
        ...
        let addon_fields = document.querySelectorAll('.bixxs_events_addon_field_wrapper');
        ...
        // Add eventlistener
        document.getElementById('bixxs_events_field[' + next_number +'][selection]').addEventListener("change", (event) => {
            let value = event.target.value;
